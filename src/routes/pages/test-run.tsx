      ...
      <div class="p-6 lg:p-8">
        <div class="max-w-4xl mx-auto">
          ...
          <div class="flex items-center justify-between mb-6">
            <div>
              <h1 class="text-2xl font-bold text-neutral-900">Test Run</h1>
      ...
      <div class="p-6 lg:p-8">
        ...
        <div class="mb-6">
          <div class="flex items-center gap-2 text-sm text-neutral-500 mb-2">
            ...
            <span>/</span>
            <span class="text-primary-600">{suite.suite.title}</span>
          </div>
          
          <div class="flex items-start justify-between">
            <div>
              <h1 class="text-3xl font-bold text-neutral-900 mb-2">{suite.suite.title}</h1>
        ...
        <Card className="mb-6">
          <div class="flex items-center justify-between mb-4">
            <h3 class="text-lg font-semibold text-neutral-900">Execution Progress</h3>
            <span class="text-sm text-neutral-600">
              {total > 0 ? Math.round(((passed + failed + blocked) / total) * 100) : 0}% Complete
            </span>
          </div>
          <div class="h-3 bg-neutral-200 rounded-full overflow-hidden flex">
            {passed > 0 && (
                  ...
                  <div class="flex items-center justify-between">
                    <div class="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <span class="font-medium text-neutral-900">{testCase?.title}</span>
                        {steps.length > 0 && (
                    ...
                    {/* Status badge only in collapsed view */}
                    <span 
                  ...
                  <div class="p-4 bg-neutral-50">
                    {testCase?.description && (
                      <div class="mb-4">
                        ...
                        <p class="text-sm text-neutral-600">{testCase.description}</p>
                      </div>
                    )}
                    ...
                    {testCase?.preConditions && (
                      <div class="mb-4">
                        ...
                        <p class="text-sm text-neutral-600">{testCase.preConditions}</p>
                      </div>
                    )}
                    ...
                    {steps.length > 0 && (
                      <div class="mb-4">
                        <div class="flex items-center justify-between mb-3">
                          <h4 class="text-sm font-medium text-neutral-700">Test Steps</h4>
                          {canEdit && (
                            <div class="flex items-center gap-2">
                              <span class="text-xs text-neutral-500 mr-1">Mark All:</span>
                              <button
                                type="button"
                                x-on:click="stepResults.forEach(s => s.status = 'Passed'); status = 'Passed'; saveStepResults()"
                                class="px-3 py-1.5 text-xs font-medium rounded-full transition-all duration-200 flex items-center gap-1.5"
                              ...
                              >
                                ...
                                <span x-text="status === 'Passed' ? 'Passed' : 'Pass All'">Pass All</span>
                              </button>
                              <button
                                type="button"
                              ...
                              >
                                ...
                                <span x-text="status === 'Failed' ? 'Failed' : 'Fail'">Fail</span>
                              </button>
                              <button
                                type="button"
                              ...
                              >
                                ...
                                <span x-text="status === 'Blocked' ? 'Blocked' : 'Block'">Block</span>
                              </button>
                            </div>
                          )}
                        </div>
                          ...
                          {steps.map((step, index) => (
                            ...
                            >
                              ...
                              <div class="flex items-stretch">
                                {/* Step Number */}
                                <div 
                                  class="w-12 flex-shrink-0 flex items-center justify-center border-r border-neutral-200 transition-all duration-200"
                                ...
                                <div class="flex-1 p-3">
                                  <div class="grid grid-cols-2 gap-4 mb-2">
                                    <div>
                                      <div class="text-xs font-semibold text-neutral-500 uppercase tracking-wide mb-1">Action</div>
                                      <div class="text-sm text-neutral-800">{step.action}</div>
                                    </div>
                                    <div>
                                      <div class="text-xs font-semibold text-neutral-500 uppercase tracking-wide mb-1">Expected Result</div>
                                      <div class="text-sm text-neutral-600">{step.expectedResult || '-'}</div>
                                    </div>
                                  </div>
                                    ...
                                    <div class="mt-3 pt-3 border-t border-neutral-100">
                                      <div class="flex items-center gap-3">
                                        ...
                                        <input
                                          ...
                                          class="flex-1 px-3 py-1.5 text-xs text-neutral-700 bg-neutral-50 border-0 rounded-full focus:ring-2 focus:ring-primary-200 focus:bg-white placeholder-neutral-400"
                                        />
                                      </div>
                                    </div>
                                  )}
                                ...
                                {/* Result Buttons */}
                                <div class="w-24 flex-shrink-0 flex flex-col gap-1.5 p-2 border-l border-neutral-200 bg-neutral-50/30 justify-center">
                                  {canEdit ? (
                                    <>
                                      <button
                                        type="button"
